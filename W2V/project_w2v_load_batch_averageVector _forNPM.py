...
def main():
    ...
    op = config['SimilarityCalculate']['NPM_average']
    ...
    with open(op, 'a', newline='',encoding = 'utf-8-sig') as csvFile_op:
        ...
        with open(fn,'r', encoding='utf-8-sig') as csvFile_ip:
            ...
            for sent in sentences:
                ...
                artName = ''.join(sent[0])
                artDescibe = ''.join(sent[1])
                artURL = ''.join(sent[2])
                sentence = artName + " " + artDescibe
                countNUM=countNUM+1
                ...
                if len(word_input_sentences_list)==0:
                    ...
                    csvWriter.writerow([countNUM,artName,artDescibe, artURL, word_input_sentences_list, averageVector])
